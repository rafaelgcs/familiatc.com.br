...
export default function NewResultDialog(props: NewResultDialogProps) {
    ...
    const handleSubmitForm = async (data, setSubmitting) => {
        ...
        if (resp.success) {
            enqueueSnackbar("Resultado adicionado com sucesso!", { variant: "success", autoHideDuration: 8000 })
            onSuccess()
            handleClose()
            formik.resetForm()
        } else {
